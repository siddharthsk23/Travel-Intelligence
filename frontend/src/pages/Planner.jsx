...
export default function Planner() {
    ...
    const generateTrip = async () => {
        try {
            ...
            alert(
                `Unable to generate trip: ${error.message}`
            );
        }
    };
        ...
        <div className="min-h-screen bg-[#071126] text-white px-6 py-10">
            ...
            <div className="max-w-5xl mx-auto">
                ...
                <p className="text-gray-400 mb-10">
                    Let's turn your destination into a complete travel plan.
                </p>
                ...
                <div className="bg-[#111b32] rounded-2xl p-8 space-y-8">
                    ...
                    <div>
                        ...
                        <p className="text-gray-400 mb-3">
                            Based on your Travel Intelligence recommendation.
                        </p>
                        ...
                        <input
                            ...
                            placeholder="Your recommended destination"
